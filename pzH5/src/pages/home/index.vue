<template>
    ...
    <!--justify="space-around":在每个子元素的左右两侧均匀分配空白空间，确保子元素之间的间距相等
                                同时首尾子元素与容器边缘的间距是子元素之间间距的一半
    -->
    ...
    <van-row class="yy-list" justify="space-around" v-for="item in homeData.hospitals">
        <van-col span="6">
            <van-image width="100px" height="90px" :src="item.avatar_url" />
        </van-col>
...
onMounted(async () => {
    ...
    //Object.assign() 的核心作用就是将一个或多个源对象的(data.data)属性，复制到目标对象(homeData)中
